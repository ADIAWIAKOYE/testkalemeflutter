...
import 'package:rencontre/Modele/event_media_model.dart';
...
class _CreateEventViewState extends State<CreateEventView> {
  ...
  String event_type = 'Publique';
  List<String> list_item = ['Publique', 'Privé'];

  String accessModifier = 'fermée';
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                iconWithTitle(text: 'Créer un évènement', func: () {}),
                SizedBox(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          myText(
                            text: 'Cliquez et téléchargez une image/vidéo',
                            style: TextStyle(
                ...
                iconTitleContainer(
                  path: 'assets/#.png',
                  text: 'Entrez les balises qui iront avec l\'événement.',
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Fréquence de l\'événement',
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText:
                          'Rédigez un résumé et tous les détails que votre invité devrait connaître sur l\'événement...',
                      // border: OutlineInputBorder(
                      //   borderRadius: BorderRadius.circular(8.0),
                      // ),
                    ),
                        ...
                        child: elevatedButton(
                            onpress: () async {
                              ...
                              await dataController
                                  ...
                                  .then((value) {
                                print("L'événement est terminé");
                                isCreatingEvent(false);
                                resetControllers();
                              });
                            },
                            text: 'Crée un évènement'),
                      )),
                SizedBox(
                  height: Get.height * 0.03,
                ),
