...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  imagePickDialog() {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Choisissez la source'),
          content: Row(
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              //  Obx(()=> authController!.isProfileInformationLoading.value? Center(child: CircularProgressIndicator(),) :
                Container(
                  height: 50,
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(children: [
                        TextSpan(
                            ...
                            style: TextStyle(
                                color: Color(0xff262628), fontSize: 13)),
                        TextSpan(
                            text: 'termes, politique de données et politique de cookies',
                            style: TextStyle(
